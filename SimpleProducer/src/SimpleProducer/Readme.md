...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *SimpleProducer*):
...
Execute unit tests
```
    cd "SimpleProducer/test/SimpleProducer.Tests"
    dotnet test
```

Deploy application
```
    cd "SimpleProducer/src/SimpleProducer"
